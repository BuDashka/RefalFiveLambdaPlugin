...
public class RefalFiveLambdaResultImpl extends ASTWrapperPsiElement implements RefalFiveLambdaResult {

  public RefalFiveLambdaResultImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<RefalFiveLambdaResultTerm> getResultTermList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RefalFiveLambdaResultTerm.class);
  }
